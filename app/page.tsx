              ...
              <AnimatePresence mode="wait" initial={false}>
                {step === "role" ? (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      disabled={!selectedRoleMeta}
                      onClick={() => setStep("signin")}
                      className="cta-premium mt-5 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                  ...
                  >
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-[13px] font-semibold hover:opacity-80 transition-opacity"
                      style={{ color: PURPLE }}
                    >
                    ...
                    <div className="mt-4">
                      <h2 className="font-heading font-extrabold text-[26px] leading-tight tracking-tight">
                        Welcome,{" "}
                        <span className="whitespace-nowrap" style={{ color: "hsl(142 55% 50%)" }}>
                          {selectedRoleMeta!.title} <span aria-hidden>👋</span>
                        </span>
                      </h2>
                      <p className="mt-1.5 text-[14px] text-muted-foreground">
                    ...
                    <div className="mt-4 inline-flex items-center gap-2.5 rounded-xl border border-border/60 px-3 py-2">
                      <span
                        className="h-7 w-7 rounded-full inline-flex items-center justify-center shrink-0"
                        style={{
                          background: `color-mix(in srgb, ${selectedRoleMeta!.tone} 18%, transparent)`,
                          color: selectedRoleMeta!.tone,
                        }}
                      >
                        {(() => {
                      ...
                      <span className="font-heading font-bold text-[13px]">{selectedRoleMeta!.title}</span>
                      <span
                        className="text-[10px] font-bold uppercase tracking-[0.06em] px-2 py-0.5 rounded-full border"
                        style={{ borderColor: "hsl(142 55% 50%)", color: "hsl(142 55% 50%)" }}
                      >
                        Selected
                      </span>
                    </div>
                    ...
                    <div className="mt-5">
                      <button
                        ...
                        className="group relative w-full h-12 rounded-[14px] bg-white hover:bg-white/90 transition-colors flex items-center justify-center gap-2.5 font-heading font-bold text-[14px] text-gray-900"
                      >
                    ...
                    <p className="mt-6 text-center text-[13px] text-muted-foreground">
                      ...
                      <Link
                        href="/"
                        className="font-semibold text-primary underline decoration-primary/40 decoration-2 underline-offset-4 hover:decoration-primary transition-all"
                      >
                        Request access
                      </Link>
                    </p>
