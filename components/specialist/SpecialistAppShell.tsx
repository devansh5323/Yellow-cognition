...
// Nav matches the reference dashboard's sidebar exactly. Only /specialist/dashboard
// has real content so far — the rest are placeholder pages until their own
// section of the design is shared.
const NAV = [
  { to: "/specialist/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { to: "/specialist/students", label: "Students", icon: Users },
  { to: "/specialist/support-plans", label: "Support Plans", icon: ClipboardList },
  { to: "/specialist/review-queue", label: "Review Queue", icon: ListChecks },
  { to: "/specialist/meetings", label: "Meetings", icon: CalendarDays },
  { to: "/specialist/reports", label: "Reports", icon: BarChart3 },
  { to: "/specialist/resources", label: "Resources", icon: BookOpen },
] as const;
...
export function SpecialistAppShell({ children }: { children: React.ReactNode }) {
  ...
  const isActive = (to: string) =>
    pathname === to || (to !== "/specialist/dashboard" && pathname.startsWith(to));
  ...
  return (
    <div className="relative flex min-h-screen w-full bg-background text-foreground">
      ...
      <aside
        ...
        aria-label="Special educator navigation"
        data-tour-target="specialist-sidebar"
      >
            ...
            {NAV.map((item) => {
              ...
              return (
                ...
                >
                  {active && (
                    <motion.span
                      layoutId={reduce ? undefined : "specialist-nav-rail"}
                  ...
                  {active && (
                    <motion.span
                      layoutId={reduce ? undefined : "specialist-nav-dot"}
