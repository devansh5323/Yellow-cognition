...
const KIND_TONE: Record<TaskStrategyKind, string> = {
...
const KIND_ICON: Record<TaskStrategyKind, LucideIcon> = {
  "Whole Class": Users,
...
export function TaskRecommendsStrip({ strategies }: { strategies: TaskStrategy[] }) {
  ...
  return (
    <section
      aria-label="Yellow Recommends — Task engagement"
